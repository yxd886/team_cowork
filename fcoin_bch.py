    ...
    while True:
        try:
            ...
            if len(buy_orders) > 1:
                ...
                new_buy_price = round((buy_money / buy_amount,2))-0.01
            ...
            if len(sell_orders) > 1:
                ...
                new_sell_price =round((sell_money / sell_amount),2) +0.01
   ...
   # api.send_heart_beat()
    ...
    while True:
        try:
            ...
            price = round((ask+buy)/2,2)
            real_size = min(size,money/price,coin)
            if price-buy>=smallest_step and ask-price>=smallest_step and real_size>0.001:
